  ...
  return (
    <Draggable draggableId={order.id} index={index}>
      {(provided, snapshot) => (
        ...
        >
          <Card className="hover:shadow-md transition-shadow cursor-pointer gap-1 pt-2 shadow-sm border border-zinc-200 dark:border-zinc-800 ring-0">
            <CardHeader className="p-3 pb-2 flex flex-row items-center justify-between space-y-0 relative">
